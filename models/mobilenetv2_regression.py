...
class MobileNetV2(nn.Module):
    def __init__(self, n_class=1000, input_size=256, width_mult=1., pretrained=False):
        ...
        if pretrained:
            os.system("mkdir -p ~/.torch/models/ ; wget -nc https://box.skoltech.ru/index.php/s/iOg4p9RTjVK4yFF/download -O ~/.torch/models/mobilenetv2.pth.tar")
            state_dict = torch.load(f"{os.path.expanduser('~')}/.torch/models/mobilenetv2.pth.tar")
